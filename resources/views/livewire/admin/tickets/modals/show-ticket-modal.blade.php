                        ...
                        @foreach($ticketImages as $index => $image)
                            <div
                                ...
                                <div class="aspect-w-16 aspect-h-12">
                                    {{--
                                    Earlier:
                                    Clicking the image alone did not tell the browser to open it in a new tab.

                                    Now:
                                    The image is inside a link, so the browser knows to open it in a new tab.
                                    --}}
                                    <a href="{{ asset('storage/' . $image) }}" target="_blank">
                                        <img src="{{ asset('storage/' . $image) }}"
                                            alt="{{ __('Attachment') }} {{ $index + 1 }}"
