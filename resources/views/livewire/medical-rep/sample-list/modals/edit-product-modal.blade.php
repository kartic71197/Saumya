<x-modal name="edit-product-modal" width="w-100" height="h-auto" maxWidth="6xl">
    ...
    <select wire:model.live="category_id" id="edit_category"
            class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
...
@if($category_id && $subcategories && count($subcategories) > 0)
<div>
    <x-input-label for="edit_subcategory" :value="__('Product Subcategory (Optional)')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
    <select wire:model="subcategory_id" id="edit_subcategory"
            class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
        <option value="">{{ __('Select Subcategory') }}</option>
        @foreach($subcategories as $subcategory)
            <option value="{{ $subcategory->id }}" @selected($subcategory_id == $subcategory->id)>
