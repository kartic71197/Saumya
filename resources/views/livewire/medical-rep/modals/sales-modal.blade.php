    ...
    <div>
        @if($viewMode)
            ...
            @if($sale?->status != 'completed')
                <div
                    ...
                    <button type="button" wire:click="closeModal('medical-sale-modal')"
        ...
        @else
            ...
            <div
                ...
                <button wire:click="closeModal('medical-sale-modal')" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
            ...
            <form wire:submit.prevent="save" class="max-h-[75vh] overflow-y-auto px-6 py-6 bg-white dark:bg-gray-900">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Organization / Practice<span
                    ...
                    <div>
                        ...
                        @if(!$organization_id)
                            <p class="text-sm text-gray-600 mt-3">
                                Please select an Practice first.
                            </p>
                        @else
