                        ...
                        @auth
                            <div class="flex gap-3 mt-4 lg:mt-0">
                                <a href="{{ route('admin.blogs.edit', $blog) }}"
                                    class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg">
                                    Edit
                                </a>
                                <form method="POST" action="{{ route('admin.blogs.destroy', $blog) }}">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
