<x-app-layout>
    <div class="p-4">
        <div class="min-h-screen bg-gray-50 rounded-lg">
            <!-- Header Section -->
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Blog</h1>
                        <p class="text-gray-600 text-sm mt-1">Insights, stories, and updates</p>
                    </div>
                    @auth
                        <a href="{{ route('admin.blogs.create') }}"
                            class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg">
                ...
                @empty
                    <div class="text-center py-20">
                        ...
                        <p class="text-gray-500 text-sm max-w-md mx-auto">
                            Create your first post to get started and share your insights with the world!
                        </p>
                    </div>
                @endforelse
